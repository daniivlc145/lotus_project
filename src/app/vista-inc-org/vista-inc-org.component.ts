...
private crearNuevoElemento(elem: {[clave:string]:string}): void {
  ...
  labelUbi.setAttribute('style',' font-size: 18px;  text-align: left;color: #3a5e62; position: absolute;z-index: 3;margin-top: 100px; left: 7%; ')
  ...
  labeldesc.setAttribute('style',' font-size: 18px;  text-align: left;color: #3a5e62; position: absolute;z-index: 3; margin-top: 140px; left: 7%; ')
  ...
  geoShapeElement.setAttribute('style',' font-size: 16px;  text-align: left;color: #b5b4b8; position: absolute;z-index: 3; margin-top: 100px; left:30%; overflow: hidden; text-overflow: ellipsis; width: 170px; white-space: nowrap; overflow-wrap: break-word;')
